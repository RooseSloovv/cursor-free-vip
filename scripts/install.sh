...
get_latest_version() {
    ...
    latest_release=$(curl -s https://api.github.com/repos/RooseSloovv/cursor-free-vip/releases/latest) || {
...
install_cursor_free_vip() {
    ...
    local download_url="https://github.com/RooseSloovv/cursor-free-vip/releases/download/v${VERSION}/${binary_name}"
    ...
    if curl --output /dev/null --silent --head --fail "$download_url"; then
        ...
        if [[ "$OS" == "mac_arm64" || "$OS" == "mac_intel" ]]; then
            ...
            download_url="https://github.com/RooseSloovv/cursor-free-vip/releases/download/v${VERSION}/${binary_name}"
